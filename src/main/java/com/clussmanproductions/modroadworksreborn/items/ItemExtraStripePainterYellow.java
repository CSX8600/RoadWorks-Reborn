...
public class ItemExtraStripePainterYellow extends Item {
	public ItemExtraStripePainterYellow()
	{
		setRegistryName("extrastripepainteryellow");
		setUnlocalizedName(ModRoadworksReborn.MODID + ".extrastripepainteryellow");
	...
	private BlockStripeBase getBlockToPlace(ItemStack stack)
	{
		...
		{
			case 0:
				return ModBlocks.cornerStripeYellow;
			case 1:
				return ModBlocks.cornerVerticalExtensionYellow;
			case 2:
				return ModBlocks.cornerHorizontalExtensionYellow;
			case 3:
				return ModBlocks.cornerBothExtensionsYellow;
			case 4:
				return ModBlocks.stripeUpperExtensionYellow;
			case 5:
				return ModBlocks.stripeBottomExtensionYellow;
			case 6:
				return ModBlocks.bottomStripeEndExtensionYellow;
			case 7:
				return ModBlocks.upperStripeStartExtensionYellow;
			case 8:
				return ModBlocks.stripeMiddleExtensionYellow;
			case 9:
				return ModBlocks.extraSmallCornerYellow;
			case 10:
				return ModBlocks.cornerExtensionYellow;
			default:
				return null;
		}
	}
